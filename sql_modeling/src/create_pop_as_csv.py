...
with open( "modeled_pop.csv", "w", newline='' ) as csvfile:
...
get_eula_query = f"SELECT node, FLOOR(age) AS age, COUNT(*) AS total_individuals FROM agents GROUP BY node, FLOOR(age) ORDER BY node, age"
